...
export function isGoogleLoginEnabled(value = import.meta.env.VITE_ENABLE_GOOGLE_LOGIN): boolean {
...
export async function googleLogin(idToken: string): Promise<{ accessToken: string }> {
