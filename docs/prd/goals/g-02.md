...
-[] PR-4 feat(api): template versioning + friend sharing
...
-[] PR-5 feat(api): sharing notification API
...
-[] PR-6 feat(web): template list, editor, and API clients
...
-[] PR-7 feat(web): version history, sharing notification UI, custom exercise dialog
